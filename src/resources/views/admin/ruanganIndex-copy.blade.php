...
<div class="relative overflow-x-auto h-screen bgSecondITS shadow-md sm:rounded-lg">
  ...
  <div class="py-7 mt-1 ml-9">
    <div class="inline-flex rounded-md shadow-sm">
      <a href="{{route('viewClass')}}" class="px-4 py-2 text-sm font-medium text-blue-700 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
        Semua
      </a>
        ...
        @foreach($ruangans as $key => $ruangan)
          ...
          @php($isEmpty = 1)
            ...
            <div class="flex flex-col justify-center">
              ...
              <h4 class="text-center my-2">People in Room: <span id="persons"></span></h4>
            </div>
            {{-- @else
            ...
            @foreach($events as $event)
              ...
              <p class="title-font font-medium text-gray-900" id="sedangDipakai">Sedang Dipakai</p>
              @php ($isEmpty = 0)
              @break
              @endif
            @endforeach
            @if ($isEmpty)
              ...
              <p class="title-font font-medium text-gray-900" id="kosong">Kosong</p>
            @endif
            </div>
          </div>
          </div>
