...
<div class="relative overflow-x-auto h-full bgSecondITS shadow-md sm:rounded-lg">
    <nav class="flex items-center justify-center flex-wrap p-5  w-full z-0 top-0 sticky sm:justify-between">
      <div class="flex items-center flex-shrink-0 text-white mr-6">
        <div>
          <span class="text-black font-bold no-underline hover:text-white hover:no-underline text-2xl pl-2"><i class="em em-grinning"></i>Report Bulan Ini</span>
        </div>
      </div>
    </nav>
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-3">
            ...
            <div class="bg-white border rounded shadow">
                <div class="border-b p-3">
                    <h5 class="font-bold uppercase text text-gray-600">Grafik Penggunaan Ruangan</h5>
                </div>
                <div class="p-5">
