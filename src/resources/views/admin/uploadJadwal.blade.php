...
@section('content')
<div class="relative overflow-x-auto h-full bgSecondITS shadow-lg m-0 md:m-10 sm:rounded-lg">
<nav class="flex items-center justify-center flex-wrap p-5 fixed w-full z-10 top-0 sticky sm:justify-between">
    <div class="flex items-center flex-shrink-0 text-white mr-6">
    <div>
        <span class="text-black font-bold no-underline hover:no-underline text-2xl pl-2"><i class="em em-grinning"></i>Unggah Jadwal</span>
    </div>
</div>
</nav>   
